"""Utility script to download SUN397 via torchvision and build a DataLoader."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download SUN397 and build a DataLoader.",
    )
    parser.add_argument(
        "--root",
        type=Path,
...
def main() -> None:
    ...
    print(f"SUN397 downloaded to: {dataset.root}")
