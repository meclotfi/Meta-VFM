"""Utility script to download Stanford Dogs via torchvision and build a DataLoader."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download Stanford Dogs and build a DataLoader for a chosen split.",
    )
    parser.add_argument(
        "--root",
        type=Path,
...
def main() -> None:
    ...
    print(f"Stanford Dogs split '{args.split}' downloaded to: {dataset.root}")
